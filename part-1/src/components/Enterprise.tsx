...
const Enterprise = () => {
    return (
        <section className="relative mt-32 py-[72px] overflow-hidden bg-dark-blue rounded-xl">
            <h2 className="max-w-[660px] w-full mx-auto mb-10 text-center text-white text-5xl leading-[72px] font-manrope">An enterprise template to ramp up your company website</h2>

            <form className="max-w-[605px] w-full mx-auto flex gap-6">
